...
class SparseCooBuilder {
 ...
 public:
  ...
  Status GetOrCreate(bool linearized, SparseCooFomatRep*&);
  ...
  /// <param name="result">resulting representation</param>
  /// <returns>Status</returns>
  Status GetOrCreate(const TensorShape& indices_shape, void* indices_data, SparseCooFomatRep*& result);
};
